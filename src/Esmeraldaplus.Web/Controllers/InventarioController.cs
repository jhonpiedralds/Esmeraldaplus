...
namespace Esmeraldaplus.Web.Controllers
{
    public class InventarioController : Controller
    {
        ...
        {
            ViewData["IdOrdenCompra"] = new SelectList(_context.OrdenDeCompra, "IdOrdenCompra", "Producto");
            ViewData["IdOrdenVenta"] = new SelectList(_context.OrdenDeVenta, "IdOrdenVenta", "IdOrdenVenta");
            ViewData["IdPedido"] = new SelectList(_context.Pedido, "IdPedido", "IdUsuario");
